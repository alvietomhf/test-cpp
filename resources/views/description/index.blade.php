                        ...
                        <div class="mt-2">
                            ...
                            <div class="card-subtitle float-right">
                                <a class="btn btn-info btn-modal" href="javascript:void(0);"
                                    data-href="{{ route('teacher.keterangan.create', [$competency->slug, $question->id]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->detail ?? '' }}</td>
                                                <td>
                                                    <a href="{{ route('teacher.jawaban-pertama.index', [$competency->slug, $value->id]) }}"
                                                        class="btn btn-primary btn-sm"><i class="ft-eye"></i> Jawaban</a>
                                                    <button
                                                        data-href="{{ route('teacher.keterangan.edit', [$competency->slug, $question->id, $value->id]) }}"
                                                        data-container=".app-modal"
                                                        class="btn btn-success btn-sm btn-modal"><i class="ft-edit-2"></i>
                                                        Ubah</button>
                                                    <button
                                                        data-href="{{ route('teacher.keterangan.destroy', [$competency->slug, $question->id, $value->id]) }}"
