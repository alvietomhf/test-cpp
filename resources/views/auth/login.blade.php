...
<head>
    ...
    <meta name="description" content="Aplikasi StudyRoom">
    <meta name="keywords" content="aplikasi, uji, tes, kompetensi, c++, study, room, study room">
    <meta name="author" content="haykalcs@gmail.com">
    <title>StudyRoom</title>
    <link rel="apple-touch-icon" href="{{ asset('assets/images/logo/studyroom.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/logo/studyroom.png') }}">
    <link
...
<body class="vertical-layout vertical-menu 1-column  bg-gray bg-lighten-2 blank-page" data-open="click"
                            ...
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        <div class="p-1"><img src="{{ asset('assets/images/logo/studyroom.png') }}"
                                                width="150" height="150" alt="branding logo"></div>
                                    </div>
                                    <h1 class="card-subtitle line-on-side text-center pt-2">
                                        <span>Login</span>
                                    </h1>
                                </div>
                                ...
                                <div id="forgot" style="display: none;">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <h4 class="font-italic">Silahkan Hubungi Administrator untuk Informasi
                                                Lebih Lanjut</h4>
                                        </div>
                                    </div>
                                    <p class="card-subtitle text-muted text-center mx-2 pb-2"><span><a id="btnlogin"
                                                href="javascript:void(0);"
                                                onclick="onClickLogin(this)">Masuk</a></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
