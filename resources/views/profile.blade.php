                    ...
                    <form id="edit-profile" data-action="{{ route('profile.update') }}">
                        <div class="media mb-2">
                            <a class="mr-2" href="javascript:void(0);">
                                <img src="{{ $data->avatar ? asset('storage/images/' . $data->avatar) : asset('assets/images/profile.png') }}"
                            ...
                            <div class="media-body">
                                ...
                                <div id="btn-upload" class="col-12 px-0 d-flex">
                                    <label id="lbl-avatar" class="btn btn-sm btn-info mr-25"
                                        for="image-upload">Upload</label>
                                    <input type="file" class="form-control" name="avatar" id="image-upload"
                                        onchange="onChangeFile(this)" hidden>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input oninvalid="this.setCustomValidity('Mohon diisi dengan lengkap')"
                                            oninput="this.setCustomValidity('')" type="text" id="username"
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input oninvalid="this.setCustomValidity('Mohon diisi dengan lengkap')"
                                            oninput="this.setCustomValidity('')" type="email" id="email"
                                            class="form-control" placeholder="email@email.com" name="email"
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input oninvalid="this.setCustomValidity('Mohon diisi dengan lengkap')"
                                            oninput="this.setCustomValidity('')" type="text" id="phone"
                                            class="form-control" placeholder="08123456789" name="phone"
                                        ...
                                        <div class="form-group position-relative has-icon-right">
                                            ...
                                            <div class="form-control-position">
                                                <i toggle="#password-field"
                                                    class="ft-eye font-medium-5 ml-n1 line-height-1 text-muted icon-align toggle-password"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="controls">
                                        <label for="password_confirmation">Konfirmasi Password</label><small>
                                            (opsional)</small>
                                        <div class="form-group position-relative has-icon-right">
                                            ...
                                            <div class="form-control-position">
                                                <i toggle="#password-field"
                                                    class="ft-eye font-medium-5 ml-n1 line-height-1 text-muted icon-align toggle-confirm-password"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                $.ajax({
                    ...
                    error: function(err) {
                        $.each(err.responseJSON.data, function(key, error) {
                            if (key === 'avatar') {
                                $(document).find(`[id=btn-upload]`).after(
