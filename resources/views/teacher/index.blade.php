                    ...
                    <div class="card-header">
                        ...
                        <div class="card-subtitle float-right">
                            <a class="btn btn-info btn-modal" href="javascript:void(0);"
                                data-href="{{ route('teacher.guru.create') }}" data-container=".app-modal"><i
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->phone ?? '' }}</td>
                                                <td>
                                                    <button data-href="{{ route('teacher.guru.edit', [$value->id]) }}"
                                                        data-container=".app-modal"
                                                        class="btn btn-success btn-sm btn-modal"><i class="ft-edit-2"></i>
                                                        Ubah</button>
                                                    <button data-href="{{ route('teacher.guru.destroy', [$value->id]) }}"
