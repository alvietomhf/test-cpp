                        ...
                        <div class="mt-2">
                            ...
                            <div class="card-subtitle float-right">
                                <a class="btn btn-info btn-modal" href="javascript:void(0);"
                                    data-href="{{ route('teacher.kj-kedua.create', [$firstAnswer->id, $secondAnswer->id]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <button
                                                        data-href="{{ route('teacher.kj-kedua.edit', [$firstAnswer->id, $secondAnswer->id, $value->id]) }}"
                                                        data-container=".app-modal"
                                                        class="btn btn-success btn-sm btn-modal"><i class="ft-edit-2"></i>
                                                        Ubah</button>
                                                    <button
                                                        data-href="{{ route('teacher.kj-kedua.destroy', [$firstAnswer->id, $secondAnswer->id, $value->id]) }}"
