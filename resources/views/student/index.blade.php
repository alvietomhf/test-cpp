        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Siswa {{ $clas->name }} TA.{{ $clas->season }}</h4>
                    <div class="card-subtitle float-right">
                        <a class="btn btn-info btn-modal" href="javascript:void(0);" data-href="{{ route('admin.siswa.create', [$clas->id]) }}" data-container=".app-modal"><i class="ft-plus"></i> Tambah</a>
                    </div>
                </div>
                            ...
                            <table id="datatable" class="table table-striped table-bordered datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->phone ?? '' }}</td>
                                        <td>
                                            <button data-href="{{ route('admin.siswa.edit', [$clas->id, $value->id]) }}" data-container=".app-modal" class="btn btn-success btn-sm btn-modal"><i class="ft-edit-2"></i> Ubah</button>
                                            <button data-href="{{ route('admin.siswa.destroy', [$clas->id, $value->id]) }}" class="btn btn-danger btn-sm btn-delete"><i class="ft-trash-2"></i> Hapus</button> 
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
