                    ...
                    <div class="card-header">
                        ...
                        <div class="card-subtitle float-right">
                            <a class="btn btn-info btn-modal" href="javascript:void(0);"
                                data-href="{{ route('teacher.siswa.create', [$clas->id]) }}" data-container=".app-modal"><i
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <button
                                                        data-href="{{ route('teacher.siswa.edit', [$clas->id, $value->id]) }}"
                                                        data-container=".app-modal"
                                                        class="btn btn-success btn-sm btn-modal"><i class="ft-edit-2"></i>
                                                        Ubah</button>
                                                    <button
                                                        data-href="{{ route('teacher.siswa.destroy', [$clas->id, $value->id]) }}"
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $(".buttons-copy, .buttons-print, .buttons-excel").removeClass("btn-secondary").addClass(
                "btn btn-info mr-1")
            ...
            $(document).on('click', '.toggle-confirm-password', function() {
                ...
                input2.attr('type') === 'password' ? input2.attr('type', 'text') : input2.attr('type',
                    'password')
            })
