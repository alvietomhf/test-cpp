                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('teacher.butir-jawaban.index', [$question->competency->slug, $question->id]) }}"
                        ...
                        <div class="mt-2">
                            ...
                            <div class="card-subtitle float-right">
                                <a class="btn btn-info btn-modal" href="javascript:void(0);"
                                    data-href="{{ route('teacher.kunci-jawaban.create', [$question->id, $answer->id]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <button
                                                        data-href="{{ route('teacher.kunci-jawaban.edit', [$question->id, $answer->id, $value->id]) }}"
                                                        data-container=".app-modal"
                                                        class="btn btn-success btn-sm btn-modal"><i class="ft-edit-2"></i>
                                                        Ubah</button>
                                                    <button
                                                        data-href="{{ route('teacher.kunci-jawaban.destroy', [$question->id, $answer->id, $value->id]) }}"
