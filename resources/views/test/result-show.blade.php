                ...
                @foreach ($data->resultDetails as $value)
                    <div class="col-12 border border-info p-1 mb-2" style="border-radius: 10px;">
                        ...
                        <p class="bg-info text-white font-weight-medium text-center px-2 rounded"
                            style="padding: 3px 0px; border-radius: 10px;">Analisa</p>
                            ...
                            <ul>
                                @foreach ($resultDescription->rdFirstAnswers as $rdFirstAnswer)
                                    <li>
                                        ...
                                        <span class="ml-1"
                                            style="color: {{ $rdFirstAnswer->correct ? 'green' : 'red' }};">
                                        ...
                                        <ul>
                                            @foreach ($rdFirstAnswer->rdSecondAnswers as $rdSecondAnswer)
                                                <li>
                                                    ...
                                                    <span class="ml-1"
                                                        style="color: {{ $rdSecondAnswer->correct ? 'green' : 'red' }};">
                                                    ...
                                                    <ul>
                                                        @foreach ($rdSecondAnswer->rdThirdAnswers as $rdThirdAnswer)
                                                            <li>
                                                                ...
                                                                <span class="ml-1"
                                                                    style="color: {{ $rdThirdAnswer->correct ? 'green' : 'red' }};">
                        ...
                        <div>
                            <p class="bg-info text-white font-weight-medium text-center px-2 rounded"
                                style="padding: 3px 0px; border-radius: 10px;">Kode</p>
