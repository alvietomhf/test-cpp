        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card p-2">
                    ...
                    <img src="{{ asset('storage/images/' . json_decode($question->image)[0]) }}" alt="Image"
                        width="150px">
                </div>
                <div class="card">
                        ...
                        <div class="mt-2">
                            ...
                            <div class="card-subtitle float-right">
                                <a class="btn btn-info btn-modal" href="javascript:void(0);"
                                    data-href="{{ route('teacher.output.create', [$competency->slug, $question->id]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <button
                                                        data-href="{{ route('teacher.output.edit', [$competency->slug, $question->id, $value->id]) }}"
                                                        data-container=".app-modal"
                                                        class="btn btn-success btn-sm btn-modal"><i class="ft-edit-2"></i>
                                                        Ubah</button>
                                                    <button
                                                        data-href="{{ route('teacher.output.destroy', [$competency->slug, $question->id, $value->id]) }}"
