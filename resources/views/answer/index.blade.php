            ...
            <div class="col-12">
                ...
                <div class="row breadcrumbs-top mb-1">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('teacher.pertanyaan.index', [$competency->slug]) }}"
                        ...
                        <div class="mt-2">
                            ...
                            <div class="card-subtitle float-right">
                                <a class="btn btn-info btn-modal" href="javascript:void(0);"
                                    data-href="{{ route('teacher.butir-jawaban.create', [$competency->slug, $question->id]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('teacher.kunci-jawaban.index', [$question->id, $value->id]) }}"
                                                        class="btn btn-primary btn-sm"><i class="ft-eye"></i> Kunci
                                                        Jawaban</a>
                                                    <button
                                                        data-href="{{ route('teacher.butir-jawaban.edit', [$competency->slug, $question->id, $value->id]) }}"
                                                        data-container=".app-modal"
                                                        class="btn btn-success btn-sm btn-modal"><i class="ft-edit-2"></i>
                                                        Ubah</button>
                                                    <button
                                                        data-href="{{ route('teacher.butir-jawaban.destroy', [$competency->slug, $question->id, $value->id]) }}"
