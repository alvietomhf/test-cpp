                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('teacher.jawaban-pertama.index', [$description->question->competency->slug, $description->id]) }}"
                        ...
                        <div class="mt-2">
                            ...
                            <div class="card-subtitle float-right">
                                <a class="btn btn-info btn-modal" href="javascript:void(0);"
                                    data-href="{{ route('teacher.jawaban-kedua.create', [$description->id, $firstAnswer->id]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($value->nested)
                                                        <a href="{{ route('teacher.jawaban-ketiga.index', [$firstAnswer->id, $value->id]) }}"
                                                            class="btn btn-primary btn-sm"><i class="ft-eye"></i>
                                                            Jawaban</a>
                                                    @endif
                                                    <a href="{{ route('teacher.kj-kedua.index', [$firstAnswer->id, $value->id]) }}"
                                                        class="btn btn-warning btn-sm"><i class="ft-lock"></i> Kunci</a>
                                                    <button
                                                        data-href="{{ route('teacher.jawaban-kedua.edit', [$description->id, $firstAnswer->id, $value->id]) }}"
                                                        data-container=".app-modal"
                                                        class="btn btn-success btn-sm btn-modal"><i class="ft-edit-2"></i>
                                                        Ubah</button>
                                                    <button
                                                        data-href="{{ route('teacher.jawaban-kedua.destroy', [$description->id, $firstAnswer->id, $value->id]) }}"
