$(window).on("load", function () {
    new PerfectScrollbar("#recent-orders", { wheelPropagation: !0 });
    ...
    $(window).on("load", function () {
        ...
        var e = Chart.controllers.line.prototype.draw,
            o = Chart.controllers.line.extend({
                draw: function () {
        ...
        Chart.controllers.derivedLine = o;
        var r = document.querySelector("#thisYearRevenue").getContext("2d"),
            a =
                (new Chart(r, {
                    type: "derivedLine",
                    data: {
                        ...
                        datasets: [
                            {
                                data: [
                                    5e3, 1e4, 4e3, 14500, 8e3, 18500, 8e3, 2e4,
                                ],
                                borderWidth: 4,
                                borderColor: "#512da8",
        ...
        Morris.Donut({
            ...
            data: [
                ...
                { label: "USA", value: 2500 },
                { label: "Germany", value: 2e3 },
                { label: "New York", value: 1e3 },
                { label: "Aingapore", value: 500 },
            ],
            resize: !0,
    ...
    $("#world-map-markers").vectorMap({
        ...
        onRegionTipShow: function (e, o, r) {
            o.html(o.html() + " (Visitor - " + visitorData[r] + ")");
        },
    });
