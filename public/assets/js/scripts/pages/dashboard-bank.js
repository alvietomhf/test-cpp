...
(function (window, document, $) {
     ...
     ********************************************/
    //Get the context of the Chart canvas element we want to select
    var silverChartjs = document
        .getElementById("silver-chart")
        .getContext("2d");
    // Create Linear Gradient
     ...
     ********************************************/
    //Get the context of the Chart canvas element we want to select
    var bitcoinChartjs = document
        .getElementById("bitcoin-chart")
        .getContext("2d");
    // Create Linear Gradient
    ...
    (function () {
        ...
        var MonthSeries1List = {
            name: "series-1",
            data: [
                100000, 500000, 300000, 700000, 100000, 200000, 700000, 50000,
            ],
        };
